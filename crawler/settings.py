...
FAKEUSERAGENT_PROVIDERS = [
    ...
    # If FakeUserAgentProvider fails, we'll
    # use faker to generate a user-agent string for us
...
USER_AGENT = "Mozilla/5.0 (iPad; CPU OS 12_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148"  # noqa
