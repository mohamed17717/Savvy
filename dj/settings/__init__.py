...
SWAGGER_SETTINGS = {
    "SECURITY_DEFINITIONS": {
        "api_key": {
            ...
            "in": "header",
            "name": "Authorization",
            "value": "Token 6170589c02669d3a2736c1cc2b47fdfd12d770246c253db6b35a34a9f76b87d9",  # noqa
        }
    },
...
CORS_ORIGIN_WHITELIST = ("http://localhost", "http://localhost:8080") + tuple(
    map(lambda i: f"https://{i}", ALLOWED_HOSTS)
)
